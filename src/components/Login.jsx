  ...
  return (
    <div>
      ...
      <form
        ...
        className="w-3/12 absolute rounded-lg p-12  my-36  mx-auto right-0 left-0 text-white bg-black/70  "
      >
        ...
        <button
          ...
          className=" m-4 ml-2 w-full text-white bg-red-700 h-[40px] rounded-lg"
        >
          {isSignInForm ? "Sign In" : "Sign Up"}
        </button>
